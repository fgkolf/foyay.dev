...
Watching a site use the old full-page reload felt like visiting a museum.
...
There is much more to view transitions than that, like transitioning specific elements and handling their state changes between pages, but personally I find
